        ...
        {error ? (
          ...
          <div className="min-h-0 flex-1 overflow-y-auto">
            <div className="flex h-full flex-col items-center justify-center gap-3 px-4 py-8">
              <p className="pb-1 text-[16px] font-semibold">
                Let&apos;s build!
              </p>
              {SUGGESTIONS.map((prompt) => (
                <button
                  ...
                  className="rounded-full bg-muted px-4 py-2 text-[14px] text-foreground transition-colors hover:bg-accent disabled:pointer-events-none disabled:opacity-50"
                >
                  {prompt}
                </button>
              ))}
